...
Opening an account with Sevi is very easy. Please follow the following to create your Sevi account. It takes a few minutes:
...
To get the app, proceed to Play store App on your phone, Search for Sevi and Tap `Install`. Alternatively, [download and Install the app by clicking here](https://sevi.io/app) .You're done with the first step. Welcome to Sevi!
...
Select your country from the dropdown menu by clicking on your country's flag. Fill out your phone number.

<img src="/img/PhonenumberverificationSTEP1.png" alt="verification" width="200"/>


> **NOTE**: Kindly confirm your country code and cross-check your phone number before proceeding
